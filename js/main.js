...
;(function (window) {
    ...
    var bodyEl = document.body,
        ...
        closeContentCtrl = $('button.button--close')[0],
    ...
    console.log('close content ctrl :: ', closeContentCtrl);
    ...
    function openItem(item) {
        ...
        // classie.add($('#description-content'), 'active');
